        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 pb-20 sm:pb-0">
          ...
          <TabsContent value="preferences" className="space-y-6">
            <Tabs value={groupSubTab} onValueChange={setGroupSubTab}>
              ...
              <ActivityPreferencesAccordion
                novelty={editNovelty}
                onNoveltyChange={setEditNovelty}
                categoryState={{
                  mealEnabled: editGroupData.mealEnabled,
                  cafeEnabled: editGroupData.cafeEnabled,
                  drinksEnabled: editGroupData.drinksEnabled,
                ...
                onCategoryStateChange={(updates) => setEditGroupData({ ...editGroupData, ...updates })}
                onToggleCategory={(field, value) => toggleAutomationMutation.mutate({ field, value })}
              />
              ...
              <MyPreferencesTab
                group={group}
                groupId={groupId || ""}
                membersBudgetsData={membersBudgetsData}
                membersAvailabilityData={membersAvailabilityData}
                myPreferencesBudget={myPreferencesBudget}
                setMyPreferencesBudget={setMyPreferencesBudget}
                myPreferencesCategories={myPreferencesCategories}
                setMyPreferencesCategories={setMyPreferencesCategories}
                myPreferencesAvailability={myPreferencesAvailability}
                setMyPreferencesAvailability={setMyPreferencesAvailability}
                myPreferencesMeetingFrequency={myPreferencesMeetingFrequency}
                setMyPreferencesMeetingFrequency={setMyPreferencesMeetingFrequency}
                myPreferencesMeetingFrequencyOriginal={myPreferencesMeetingFrequencyOriginal}
                setMyPreferencesMeetingFrequencyOriginal={setMyPreferencesMeetingFrequencyOriginal}
                onSavePreferences={(data) => updateMyPreferencesMutation.mutate(data)}
                isSaving={updateMyPreferencesMutation.isPending}
