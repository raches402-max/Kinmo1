 ...
 * No upfront Manual-vs-AI fork, no quick-pick chips, no marketing copy.
 *
...
import { Sparkles, Send, Calendar, MapPin, X, Check } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const SUGGESTED_TIMES = [
  { label: "Saturday, May 24 · 2:00 PM", sub: "you've both been free Saturday afternoons" },
  { label: "Friday, May 23 · 7:00 PM", sub: "matches your usual rhythm" },
  { label: "Wednesday, May 28 · 6:30 PM", sub: "Rachel mentioned she's free midweek" },
];
...
export default function PrototypeCreateEvent() {
  ...
  return (
    <div className="min-h-screen bg-muted/40">
      {/* Soft mock backdrop so the dialog reads as a modal */}
      <div className="px-6 py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Mirrors the Edit Plan dialog: same labels, same fields, same footer.
            Two paths per field — fill it in, or tap the helper.
          </p>
          {!open && (
          ...
          <div className="space-y-6 pt-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <HelperLink
                  label="ask the group when they're free"
                  onClick={askGroupWhen}
                  loading={whenHelperLoading}
                  disabled={whenHelperOpen}
                />
              </div>
              <Input
                  ...
                  >
                    {SUGGESTED_TIMES.map((t, i) => (
                      <SuggestionRow
                        ...
                        sub={t.sub}
                        onPick={() => {
                          // Just fake a value for the prototype
