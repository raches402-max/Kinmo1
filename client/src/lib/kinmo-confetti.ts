...
/**
 * Fires a smaller, more subtle Kinmo confetti burst
 * Good for secondary celebrations or confirmations
 */
export function fireKinmoConfettiSubtle() {
  fireKinmoConfetti({
    particleCount: 40,
    spread: 50,
    origin: { y: 0.5 },
...
/**
 * Fires an extra celebratory Kinmo confetti burst
 * Good for major achievements like "Gang's all here"
 */
export function fireKinmoConfettiCelebration() {
  // Initial big burst
  fireKinmoConfetti({
    particleCount: 120,
    spread: 80,
