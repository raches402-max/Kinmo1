 ...
 * Provides a consistent API regardless of screen size
 */
...
// Trigger components (same for both Dialog and Drawer)
export { DialogTrigger as ResponsiveDialogTrigger } from "@/components/ui/dialog";
export { DrawerClose as ResponsiveDialogClose } from "@/components/ui/drawer";
